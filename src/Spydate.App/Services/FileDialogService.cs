...
public sealed class FileDialogService : IFileDialogService
{
    public string? OpenPeFile()
    {
        var dialog = new OpenFileDialog
        {
            ...
            Filter = "PE files (*.exe;*.dll;*.sys;*.ocx;*.scr;*.drv;*.efi;*.mui)|*.exe;*.dll;*.sys;*.ocx;*.scr;*.drv;*.efi;*.mui|ELF files (*.so;*.so.*;*.o;*.elf)|*.so;*.so.*;*.o;*.elf|Java archives (*.jar)|*.jar|Android packages (*.apk)|*.apk|All files (*.*)|*.*",
